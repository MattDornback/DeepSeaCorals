...
setwd('C:/Users/matt.dornback/R_Working_Directory/DeepSeaCorals/OBIS/')
...
RecordType_type <- list('specimen'="PreservedSpecimen", 'literature'="HumanObservation", 'still image'="MachineObservation", 'video observation'="MachineObservation", 'video transect'="MachineObservation", 'still image transect'="MachineObservation", 'catch record'="HumanObservation")
# use RecordType to basisOfRecord crosswalk to apply type valid values: 
DB_subset2$type <- recode(DB_subset2$ basisOfRecord, !!!RecordType_type)
