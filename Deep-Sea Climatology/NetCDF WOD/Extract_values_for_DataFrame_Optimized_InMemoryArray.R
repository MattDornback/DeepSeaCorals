...
mydata <- read.csv('C:/Users/matt.dornback/R_Working_Directory/DeepSeaCorals/Deep-Sea Climatology/DSC_Location_Sub.csv', stringsAsFactors = F)
...
for (i in 1:nrow(mydata)){
  ...
  iz <- which.min (abs(mydata$DepthInMeters[i] - nc_z )) 
...
write.csv(mydata,file="mydata_forloop_method.csv", row.names = F)
