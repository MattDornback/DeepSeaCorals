...
namesToMatch <- c("Solea soleo", "Abra Albo")
...
vernacular_url <- sprintf("https://www.marinespecies.org/rest/AphiaVernacularsByAphiaID/127160")

vernacular_names <- fromJSON(vernacular_url)
